    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="认领编号" prop="renlingbianhao">
            <el-input v-model="ruleForm.renlingbianhao" 
                placeholder="认领编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.renlingbianhao" label="认领编号" prop="renlingbianhao">
              <el-input v-model="ruleForm.renlingbianhao" 
                placeholder="认领编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="物品特征" prop="wupintezheng">
          <el-input v-model="ruleForm.wupintezheng" 
              placeholder="物品特征" clearable  :readonly="ro.wupintezheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="物品特征" prop="wupintezheng">
              <el-input v-model="ruleForm.wupintezheng" 
                placeholder="物品特征" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="物品颜色" prop="wupinyanse">
          <el-input v-model="ruleForm.wupinyanse" 
              placeholder="物品颜色" clearable  :readonly="ro.wupinyanse"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="物品颜色" prop="wupinyanse">
              <el-input v-model="ruleForm.wupinyanse" 
                placeholder="物品颜色" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="物品大小" prop="wupindaxiao">
          <el-select :disabled="ro.wupindaxiao" v-model="ruleForm.wupindaxiao" placeholder="请选择物品大小">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="物品大小" prop="wupindaxiao">
	      <el-input v-model="ruleForm.wupindaxiao"
                placeholder="物品大小" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.wupinmingcheng = true;
          ...
          if(o=='wupintezheng'){
            this.ruleForm.wupintezheng = obj[o];
	    this.ro.wupintezheng = true;
            continue;
          }
          if(o=='wupinyanse'){
            this.ruleForm.wupinyanse = obj[o];
	    this.ro.wupinyanse = true;
            continue;
          }
          if(o=='tupian'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='wupindaxiao'){
            this.ruleForm.wupindaxiao = obj[o];
	    this.ro.wupindaxiao = true;
            continue;
          }
          if(o=='renlingshijian'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `renlingyanzheng/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.renlingyanzhengCrossAddOrUpdateFlag = false;
						 this.parent.search();
